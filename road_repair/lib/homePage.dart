...
import 'package:road_repair/locateButton.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        //       child: FireMap()),
        // ),
        Positioned(left: 0, right: 0, top: 0, child: getAppBarUI()),
      ],
    );
  }
...
class _MapScreenState extends State<MapScreen> with TickerProviderStateMixin {
  ...
  void addAllListData() {
    ...
    listViews.add(SizedBox(height: 500, width: 150, child: FireMap()));
  }
